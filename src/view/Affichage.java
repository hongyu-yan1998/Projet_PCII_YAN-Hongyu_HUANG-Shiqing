...
public class Affichage extends JPanel {
     ...
     * @param etat
     */
    public Affichage(Etat etat, VueNuage vueNuage, VueOiseau vueOiseau, VueAdversaire vueAdversaire) {
        this.etat = etat;
        this.vueNuage = vueNuage;
        this.vueOiseau = vueOiseau;
        this.vueAdversaire = vueAdversaire;
     ...
     * @return
     */
    public VueAdversaire getVueAdversaire() {
        return vueAdversaire;
    }
    ...
    public void paint(Graphics g) {
        ...
        g2.draw(new Line2D.Double(etat.getPiste().getPointControle().getX(),
                etat.getPiste().getPointControle().getY(),
                etat.getPiste().getPointControle().getX()+Piste.WID_PISTE,
                etat.getPiste().getPointControle().getY()));
        g2.drawImage(etat.getPiste().getPointControle().getImg(),
                (int)etat.getPiste().getPointControle().getX() + Piste.WID_PISTE,
                (int)etat.getPiste().getPointControle().getY() - 45, 35, 45, null);
        ...
        vueAdversaire.dessiner(g2);

        //dessine le véhicule
        g2.drawImage(etat.getImg(), etat.getPosition(), etat.getY_veh(), WIDTH, HEIGHT, null);
        //dessine l'ombre
        g2.drawImage(etat.getOmbre().getImg(), etat.getOmbre().getX(),etat.getOmbre().getY(), etat.getOmbre().getWidth(),etat.getOmbre().getHeight(), null);
        //dessine les nuages
        ...
        g.drawString("Score: " + etat.getScore(), LARG - 100, 20);
